...
def plot_spectrum(energies):
    ...
    ax.set_ylim((np.amin(energies)-0.1),(np.amax(energies)+0.1))
    ...
    ax.plot(np.arange(1,totalstates+1),energies, color='salmon', lw=2, marker='8')
    ...
    plt.savefig('quasienergies.png',transparent=False)